...
namespace EasyRooms.Tests.UnitTests
{
    public class RoomOccupationsFillterTests
    {
        ...
        public RoomOccupationsFillterTests()
        {
            ...
            _roomsOccupationsFiller =
                new RoomOccupationsFiller(_occupationKeyInformationExtractor, _therapyFiller, _roomListCreator);
        }
        ...
        public void Distrubutes_Overlapping_Rows_Between_Two_Rooms()
        {
            ...
            var expectedRoom1 = new Room("room1", 0).AddOccupation(new Occupation("Wadim", "Hans", "short", "long",
                new TimeSpan(8, 0, 0), new TimeSpan(12, 0, 0)));
            var expectedRoom2 = new Room("room2", 1).AddOccupation(new Occupation("Dani", "Carmen", "short2", "long2",
                new TimeSpan(10, 0, 0), new TimeSpan(14, 0, 0)));
        ...
        public void Distrubutes_Overlapping_Rows_Between_Two_Rooms_With_Buffer()
        {
            ...
            var expectedRoom1 = new Room("room1", 0).AddOccupation(new Occupation("Wadim", "Hans", "short", "long",
                new TimeSpan(8, 0, 0), new TimeSpan(8, 55, 0)));
            var expectedRoom2 = new Room("room2", 1).AddOccupation(new Occupation("Dani", "Carmen", "short2", "long2",
        ...
        public void Partner_Massages_Get_Priority_Over_All_Others()
        {
            ...
            var expectedRoom1 = new Room("room1", 0)
                .AddOccupation(new Occupation("Partner1", "PartnerPatient", "*PARTNER", "long", new TimeSpan(9, 0, 0),
                    new TimeSpan(10, 0, 0)))
                .AddOccupation(new Occupation("Partner2", "PartnerPatient", "*PARTNER", "long", new TimeSpan(9, 0, 0),
                    new TimeSpan(10, 0, 0)));
            var expectedRoom2 = new Room("room2", 1).AddOccupation(new Occupation("Dani", "Carmen", "short2", "long2",
                new TimeSpan(9, 0, 0), new TimeSpan(10, 0, 0)));
            var roomNames = new RoomNames {RoomsString = "room1\nroom2"};
